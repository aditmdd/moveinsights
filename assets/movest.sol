...
contract MoveInsights is Context, IERC20, Ownable {
    ...
    address payable public _PutinHypeMarketing =
        payable(address(0x6E4930f22d7B0d38e7dC96EdCDbE44a8b11A2A1F));
    ...
    constructor() {
        ...
        _isExcludedFromFee[_PutinHypeMarketing] = true;
    ...
    function updateMarketingWallet(address payable newAddress)
        ...
        onlyOwner
    {
        _PutinHypeMarketing = newAddress;
    }
    ...
    function _takeMarketing(uint256 tMarketing) private {
        uint256 currentRate = _getRate();
        uint256 rMarketing = tMarketing.mul(currentRate);
        _rOwned[_PutinHypeMarketing] = _rOwned[_PutinHypeMarketing].add(
            rMarketing
        );
        if (_isExcluded[_PutinHypeMarketing])
            _tOwned[_PutinHypeMarketing] = _tOwned[_PutinHypeMarketing].add(
                tMarketing
            );
    }
